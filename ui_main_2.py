...
"")
        ...
        self.page.setGeometry(QRect(0, 0, 105, 353))
        ...
        self.page_4.setGeometry(QRect(0, 0, 110, 353))
        ...
        self.page_3.setGeometry(QRect(0, 0, 110, 353))
        ...
        self.page_7.setGeometry(QRect(0, 0, 16, 353))
        self.toolBox.addItem(self.page_7, u"Relat\u00f3rios")
        self.page_2 = QWidget()
        self.page_2.setObjectName(u"page_2")
        self.page_2.setGeometry(QRect(0, 0, 16, 353))
...
"}")
        ...
        self.txt_cnpj_fornecedor = QLineEdit(self.widget_16)
        self.txt_cnpj_fornecedor.setObjectName(u"txt_cnpj_fornecedor")

        self.gridLayout_4.addWidget(self.txt_cnpj_fornecedor, 1, 1, 1, 1)

        self.txt_nome_fornecedor = QLineEdit(self.widget_16)
        self.txt_nome_fornecedor.setObjectName(u"txt_nome_fornecedor")

        self.gridLayout_4.addWidget(self.txt_nome_fornecedor, 1, 3, 1, 1)

        self.verticalSpacer_6 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_4.addItem(self.verticalSpacer_6, 3, 1, 1, 1)

        self.txt_email_fornecedor = QLineEdit(self.widget_16)
        self.txt_email_fornecedor.setObjectName(u"txt_email_fornecedor")

        self.gridLayout_4.addWidget(self.txt_email_fornecedor, 2, 3, 1, 1)

        self.btn_cnpj = QPushButton(self.widget_16)
        ...
        self.gridLayout_4.addWidget(self.btn_cnpj, 1, 2, 1, 1)

        self.txt_telefone_fornecedor = QLineEdit(self.widget_16)
        self.txt_telefone_fornecedor.setObjectName(u"txt_telefone_fornecedor")

        self.gridLayout_4.addWidget(self.txt_telefone_fornecedor, 2, 1, 1, 2)
...
"}")
        ...
        self.txt_email_usuario = QLineEdit(self.widget_19)
        self.txt_email_usuario.setObjectName(u"txt_email_usuario")

        self.gridLayout_5.addWidget(self.txt_email_usuario, 2, 1, 1, 1)

        self.txt_nome_usuario = QLineEdit(self.widget_19)
        ...
        self.gridLayout_5.addWidget(self.txt_nome_usuario, 0, 0, 1, 2)

        self.txt_cpf_usuario = QLineEdit(self.widget_19)
        self.txt_cpf_usuario.setObjectName(u"txt_cpf_usuario")

        self.gridLayout_5.addWidget(self.txt_cpf_usuario, 2, 0, 1, 1)

        self.txt_criar_senha = QLineEdit(self.widget_19)
        self.txt_criar_senha.setObjectName(u"txt_criar_senha")
        self.txt_criar_senha.setEchoMode(QLineEdit.EchoMode.Password)

        self.gridLayout_5.addWidget(self.txt_criar_senha, 8, 0, 1, 1)

        self.verticalSpacer_4 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_5.addItem(self.verticalSpacer_4, 7, 0, 1, 1)

        self.txt_repetir_senha = QLineEdit(self.widget_19)
        self.txt_repetir_senha.setObjectName(u"txt_repetir_senha")
        self.txt_repetir_senha.setEchoMode(QLineEdit.EchoMode.Password)

        self.gridLayout_5.addWidget(self.txt_repetir_senha, 9, 0, 1, 1)
        ...
        self.pushButton_16.setGeometry(QRect(840, 30, 80, 27))
...
"}")
        ...
        self.txt_complemento_cliente = QLineEdit(self.widget_6)
        self.txt_complemento_cliente.setObjectName(u"txt_complemento_cliente")

        self.gridLayout.addWidget(self.txt_complemento_cliente, 2, 0, 1, 1)

        self.txt_nome_cliente = QLineEdit(self.widget_6)
        self.txt_nome_cliente.setObjectName(u"txt_nome_cliente")

        self.gridLayout.addWidget(self.txt_nome_cliente, 0, 0, 1, 2)

        self.txt_logradouro_cliente = QLineEdit(self.widget_6)
        self.txt_logradouro_cliente.setObjectName(u"txt_logradouro_cliente")

        self.gridLayout.addWidget(self.txt_logradouro_cliente, 1, 0, 1, 2)

        self.txt_bairro_cliente = QLineEdit(self.widget_6)
        self.txt_bairro_cliente.setObjectName(u"txt_bairro_cliente")

        self.gridLayout.addWidget(self.txt_bairro_cliente, 2, 1, 1, 1)

        self.txt_email_cliente = QLineEdit(self.widget_6)
        self.txt_email_cliente.setObjectName(u"txt_email_cliente")

        self.gridLayout.addWidget(self.txt_email_cliente, 3, 0, 1, 1)

        self.txt_numero_cliente = QLineEdit(self.widget_6)
        self.txt_numero_cliente.setObjectName(u"txt_numero_cliente")

        self.gridLayout.addWidget(self.txt_numero_cliente, 1, 2, 1, 1)

        self.txt_cpf_cliente = QLineEdit(self.widget_6)
        self.txt_cpf_cliente.setObjectName(u"txt_cpf_cliente")

        self.gridLayout.addWidget(self.txt_cpf_cliente, 0, 2, 1, 1)

        self.txt_telefone_cliente = QLineEdit(self.widget_6)
        self.txt_telefone_cliente.setObjectName(u"txt_telefone_cliente")

        self.gridLayout.addWidget(self.txt_telefone_cliente, 2, 2, 1, 1)
        ...
        self.btn_salvar_cliente.setGeometry(QRect(840, 30, 80, 27))
...
"}")
        ...
        self.gridLayout_2.addWidget(self.txt_nome_produto, 0, 0, 1, 2)
        ...
        self.pushButton_13.setMinimumSize(QSize(80, 31))
        self.pushButton_13.setMaximumSize(QSize(80, 31))
        ...
        self.label_7.setGeometry(QRect(570, 220, 56, 19))
...
"}")
        ...
        self.txt_subtotal = QLineEdit(self.widget_22)
        ...
        self.txt_quantidade = QLineEdit(self.widget_22)
        self.txt_quantidade.setObjectName(u"txt_quantidade")

        self.gridLayout_6.addWidget(self.txt_quantidade, 2, 2, 1, 1)

        self.txt_valor_unitario = QLineEdit(self.widget_22)
        self.txt_valor_unitario.setObjectName(u"txt_valor_unitario")

        self.gridLayout_6.addWidget(self.txt_valor_unitario, 2, 3, 1, 1)

        self.txt_numero_pedido = QLineEdit(self.widget_22)
        self.txt_numero_pedido.setObjectName(u"txt_numero_pedido")

        self.gridLayout_6.addWidget(self.txt_numero_pedido, 0, 1, 1, 1)

        self.txt_total = QLineEdit(self.widget_22)
        self.txt_total.setObjectName(u"txt_total")

        self.gridLayout_6.addWidget(self.txt_total, 3, 4, 1, 1)

        self.comboBox_5 = QComboBox(self.widget_22)
        self.comboBox_5.setObjectName(u"comboBox_5")

        self.gridLayout_6.addWidget(self.comboBox_5, 1, 1, 1, 2)
        ...
        self.horizontalSpacer_3 = QSpacerItem(919, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_5.addItem(self.horizontalSpacer_3)

        self.pushButton_17 = QPushButton(self.widget_23)
        self.pushButton_17.setObjectName(u"pushButton_17")
        self.pushButton_17.setMinimumSize(QSize(80, 31))
        self.pushButton_17.setMaximumSize(QSize(80, 31))
...
"}")
        ...
        self.lineEdit_20 = QLineEdit(self.splitter_2)
        self.lineEdit_20.setObjectName(u"lineEdit_20")
        self.splitter_2.addWidget(self.lineEdit_20)
        self.comboBox_4 = QComboBox(self.splitter_2)
        self.comboBox_4.setObjectName(u"comboBox_4")
        self.splitter_2.addWidget(self.comboBox_4)
        ...
        if (self.tb_clientes.rowCount() < 4):
            self.tb_clientes.setRowCount(4)
        __qtablewidgetitem9 = QTableWidgetItem()
        __qtablewidgetitem9.setCheckState(Qt.Unchecked);
        self.tb_clientes.setItem(0, 0, __qtablewidgetitem9)
        __qtablewidgetitem10 = QTableWidgetItem()
        self.tb_clientes.setItem(0, 1, __qtablewidgetitem10)
        __qtablewidgetitem11 = QTableWidgetItem()
        self.tb_clientes.setItem(0, 2, __qtablewidgetitem11)
        __qtablewidgetitem12 = QTableWidgetItem()
        self.tb_clientes.setItem(0, 3, __qtablewidgetitem12)
        __qtablewidgetitem13 = QTableWidgetItem()
        self.tb_clientes.setItem(0, 4, __qtablewidgetitem13)
        __qtablewidgetitem14 = QTableWidgetItem()
        self.tb_clientes.setItem(0, 5, __qtablewidgetitem14)
        __qtablewidgetitem15 = QTableWidgetItem()
        self.tb_clientes.setItem(0, 6, __qtablewidgetitem15)
        __qtablewidgetitem16 = QTableWidgetItem()
        self.tb_clientes.setItem(0, 7, __qtablewidgetitem16)
        __qtablewidgetitem17 = QTableWidgetItem()
        self.tb_clientes.setItem(0, 8, __qtablewidgetitem17)
...
"}")
        ...
        self.lineEdit_57 = QLineEdit(self.splitter_3)
        self.lineEdit_57.setObjectName(u"lineEdit_57")
        self.splitter_3.addWidget(self.lineEdit_57)
        self.comboBox_6 = QComboBox(self.splitter_3)
        self.comboBox_6.setObjectName(u"comboBox_6")
        self.splitter_3.addWidget(self.comboBox_6)

        self.verticalLayout_37.addWidget(self.splitter_3)

        self.tb_produtos = QTableWidget(self.widget_49)
        if (self.tb_produtos.columnCount() < 8):
            self.tb_produtos.setColumnCount(8)
        __qtablewidgetitem18 = QTableWidgetItem()
        __qtablewidgetitem18.setFont(font);
        self.tb_produtos.setHorizontalHeaderItem(0, __qtablewidgetitem18)
        __qtablewidgetitem19 = QTableWidgetItem()
        __qtablewidgetitem19.setFont(font);
        self.tb_produtos.setHorizontalHeaderItem(1, __qtablewidgetitem19)
        __qtablewidgetitem20 = QTableWidgetItem()
        __qtablewidgetitem20.setFont(font);
        self.tb_produtos.setHorizontalHeaderItem(2, __qtablewidgetitem20)
        __qtablewidgetitem21 = QTableWidgetItem()
        __qtablewidgetitem21.setFont(font);
        self.tb_produtos.setHorizontalHeaderItem(3, __qtablewidgetitem21)
        __qtablewidgetitem22 = QTableWidgetItem()
        __qtablewidgetitem22.setFont(font);
        self.tb_produtos.setHorizontalHeaderItem(4, __qtablewidgetitem22)
        __qtablewidgetitem23 = QTableWidgetItem()
        __qtablewidgetitem23.setFont(font);
        self.tb_produtos.setHorizontalHeaderItem(5, __qtablewidgetitem23)
        __qtablewidgetitem24 = QTableWidgetItem()
        __qtablewidgetitem24.setFont(font);
        self.tb_produtos.setHorizontalHeaderItem(6, __qtablewidgetitem24)
        __qtablewidgetitem25 = QTableWidgetItem()
        __qtablewidgetitem25.setFont(font);
        self.tb_produtos.setHorizontalHeaderItem(7, __qtablewidgetitem25)
        if (self.tb_produtos.rowCount() < 4):
            self.tb_produtos.setRowCount(4)
        __qtablewidgetitem26 = QTableWidgetItem()
        __qtablewidgetitem26.setCheckState(Qt.Unchecked);
        self.tb_produtos.setItem(0, 0, __qtablewidgetitem26)
        __qtablewidgetitem27 = QTableWidgetItem()
        self.tb_produtos.setItem(0, 1, __qtablewidgetitem27)
        __qtablewidgetitem28 = QTableWidgetItem()
        self.tb_produtos.setItem(0, 2, __qtablewidgetitem28)
        __qtablewidgetitem29 = QTableWidgetItem()
        self.tb_produtos.setItem(0, 3, __qtablewidgetitem29)
        __qtablewidgetitem30 = QTableWidgetItem()
        self.tb_produtos.setItem(0, 4, __qtablewidgetitem30)
        __qtablewidgetitem31 = QTableWidgetItem()
        self.tb_produtos.setItem(0, 5, __qtablewidgetitem31)
        __qtablewidgetitem32 = QTableWidgetItem()
        self.tb_produtos.setItem(0, 6, __qtablewidgetitem32)
        __qtablewidgetitem33 = QTableWidgetItem()
        self.tb_produtos.setItem(0, 7, __qtablewidgetitem33)
...
"}")
        ...
        self.pushButton_26 = QPushButton(self.widget_50)
        self.pushButton_26.setObjectName(u"pushButton_26")
        self.pushButton_26.setEnabled(True)
        self.pushButton_26.setMinimumSize(QSize(80, 31))
        self.pushButton_26.setMaximumSize(QSize(80, 31))

        self.horizontalLayout_8.addWidget(self.pushButton_26)

        self.pushButton_29 = QPushButton(self.widget_50)
        self.pushButton_29.setObjectName(u"pushButton_29")
        self.pushButton_29.setMinimumSize(QSize(80, 31))

        self.horizontalLayout_8.addWidget(self.pushButton_29)

        self.pushButton_30 = QPushButton(self.widget_50)
        self.pushButton_30.setObjectName(u"pushButton_30")
        self.pushButton_30.setMinimumSize(QSize(80, 31))
...
"}")
        ...
        self.lineEdit_10 = QLineEdit(self.splitter)
        self.lineEdit_10.setObjectName(u"lineEdit_10")
        self.splitter.addWidget(self.lineEdit_10)
        ...
        self.tb_produtos_2 = QTableWidget(self.widget_12)
        if (self.tb_produtos_2.columnCount() < 8):
            self.tb_produtos_2.setColumnCount(8)
        __qtablewidgetitem34 = QTableWidgetItem()
        __qtablewidgetitem34.setFont(font);
        self.tb_produtos_2.setHorizontalHeaderItem(0, __qtablewidgetitem34)
        __qtablewidgetitem35 = QTableWidgetItem()
        __qtablewidgetitem35.setFont(font);
        self.tb_produtos_2.setHorizontalHeaderItem(1, __qtablewidgetitem35)
        __qtablewidgetitem36 = QTableWidgetItem()
        __qtablewidgetitem36.setFont(font);
        self.tb_produtos_2.setHorizontalHeaderItem(2, __qtablewidgetitem36)
        __qtablewidgetitem37 = QTableWidgetItem()
        __qtablewidgetitem37.setFont(font);
        self.tb_produtos_2.setHorizontalHeaderItem(3, __qtablewidgetitem37)
        __qtablewidgetitem38 = QTableWidgetItem()
        __qtablewidgetitem38.setFont(font);
        self.tb_produtos_2.setHorizontalHeaderItem(4, __qtablewidgetitem38)
        __qtablewidgetitem39 = QTableWidgetItem()
        __qtablewidgetitem39.setFont(font);
        self.tb_produtos_2.setHorizontalHeaderItem(5, __qtablewidgetitem39)
        __qtablewidgetitem40 = QTableWidgetItem()
        __qtablewidgetitem40.setFont(font);
        self.tb_produtos_2.setHorizontalHeaderItem(6, __qtablewidgetitem40)
        __qtablewidgetitem41 = QTableWidgetItem()
        self.tb_produtos_2.setHorizontalHeaderItem(7, __qtablewidgetitem41)
        if (self.tb_produtos_2.rowCount() < 4):
            self.tb_produtos_2.setRowCount(4)
        __qtablewidgetitem42 = QTableWidgetItem()
        __qtablewidgetitem42.setCheckState(Qt.Unchecked);
        self.tb_produtos_2.setItem(0, 0, __qtablewidgetitem42)
        __qtablewidgetitem43 = QTableWidgetItem()
        self.tb_produtos_2.setItem(0, 1, __qtablewidgetitem43)
        __qtablewidgetitem44 = QTableWidgetItem()
        self.tb_produtos_2.setItem(0, 2, __qtablewidgetitem44)
        __qtablewidgetitem45 = QTableWidgetItem()
        self.tb_produtos_2.setItem(0, 3, __qtablewidgetitem45)
        __qtablewidgetitem46 = QTableWidgetItem()
        self.tb_produtos_2.setItem(0, 4, __qtablewidgetitem46)
        __qtablewidgetitem47 = QTableWidgetItem()
        self.tb_produtos_2.setItem(0, 5, __qtablewidgetitem47)
        __qtablewidgetitem48 = QTableWidgetItem()
        self.tb_produtos_2.setItem(0, 6, __qtablewidgetitem48)
        self.tb_produtos_2.setObjectName(u"tb_produtos_2")
        self.tb_produtos_2.setStyleSheet(u"")

        self.verticalLayout_17.addWidget(self.tb_produtos_2)
        ...
        self.pushButton_14 = QPushButton(self.widget_14)
        self.pushButton_14.setObjectName(u"pushButton_14")
        self.pushButton_14.setEnabled(True)
        self.pushButton_14.setMinimumSize(QSize(80, 31))
        self.pushButton_14.setMaximumSize(QSize(80, 31))

        self.horizontalLayout_4.addWidget(self.pushButton_14)

        self.pushButton_27 = QPushButton(self.widget_14)
        self.pushButton_27.setObjectName(u"pushButton_27")
        self.pushButton_27.setMinimumSize(QSize(80, 31))

        self.horizontalLayout_4.addWidget(self.pushButton_27)

        self.pushButton_28 = QPushButton(self.widget_14)
        self.pushButton_28.setObjectName(u"pushButton_28")
        self.pushButton_28.setMinimumSize(QSize(80, 31))
        self.pushButton_28.setMaximumSize(QSize(80, 31))
...
"}")
        ...
        self.lineEdit_115 = QLineEdit(self.splitter_7)
        self.lineEdit_115.setObjectName(u"lineEdit_115")
        self.splitter_7.addWidget(self.lineEdit_115)
        self.comboBox_13 = QComboBox(self.splitter_7)
        self.comboBox_13.setObjectName(u"comboBox_13")
        self.splitter_7.addWidget(self.comboBox_13)
        ...
        self.tb_fornecedores.setHorizontalHeaderItem(0, __qtablewidgetitem49)
        __qtablewidgetitem50 = QTableWidgetItem()
        __qtablewidgetitem50.setFont(font);
        self.tb_fornecedores.setHorizontalHeaderItem(1, __qtablewidgetitem50)
        __qtablewidgetitem51 = QTableWidgetItem()
        __qtablewidgetitem51.setFont(font);
        self.tb_fornecedores.setHorizontalHeaderItem(2, __qtablewidgetitem51)
        __qtablewidgetitem52 = QTableWidgetItem()
        __qtablewidgetitem52.setFont(font);
        self.tb_fornecedores.setHorizontalHeaderItem(3, __qtablewidgetitem52)
        if (self.tb_fornecedores.rowCount() < 4):
            self.tb_fornecedores.setRowCount(4)
        __qtablewidgetitem53 = QTableWidgetItem()
        __qtablewidgetitem53.setCheckState(Qt.Unchecked);
        self.tb_fornecedores.setItem(0, 0, __qtablewidgetitem53)
        __qtablewidgetitem54 = QTableWidgetItem()
        self.tb_fornecedores.setItem(0, 1, __qtablewidgetitem54)
        __qtablewidgetitem55 = QTableWidgetItem()
        self.tb_fornecedores.setItem(0, 2, __qtablewidgetitem55)
        __qtablewidgetitem56 = QTableWidgetItem()
        self.tb_fornecedores.setItem(0, 3, __qtablewidgetitem56)
        ...
        self.pushButton_50 = QPushButton(self.widget_96)
        self.pushButton_50.setObjectName(u"pushButton_50")
        self.pushButton_50.setEnabled(True)
        self.pushButton_50.setMinimumSize(QSize(80, 31))
        self.pushButton_50.setMaximumSize(QSize(80, 31))
        ...
        self.pushButton_52 = QPushButton(self.widget_96)
        self.pushButton_52.setObjectName(u"pushButton_52")
        self.pushButton_52.setMinimumSize(QSize(80, 31))
        self.pushButton_52.setMaximumSize(QSize(80, 31))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Cadastro de Usu\u00e1rios", None))
        ...
        self.txt_cpf_usuario.setPlaceholderText(QCoreApplication.translate("MainWindow", u"CPF", None))
        ...
        self.comboBox.setPlaceholderText(QCoreApplication.translate("MainWindow", u"UNIDADE", None))
        self.pushButton_13.setText(QCoreApplication.translate("MainWindow", u"Salvar", None))
        ...
        self.comboBox_3.setPlaceholderText(QCoreApplication.translate("MainWindow", u"SELECIONE O PRODUTO", None))
        ...
        self.comboBox_5.setPlaceholderText(QCoreApplication.translate("MainWindow", u"SELECIONE O CLIENTE", None))
        self.pushButton_17.setText(QCoreApplication.translate("MainWindow", u"Salvar", None))
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"CLIENTES", None))
        self.lineEdit_20.setPlaceholderText(QCoreApplication.translate("MainWindow", u"PESQUISAR", None))
        self.comboBox_4.setPlaceholderText(QCoreApplication.translate("MainWindow", u"SELECIONE", None))
        ...
        __sortingEnabled = self.tb_clientes.isSortingEnabled()
        self.tb_clientes.setSortingEnabled(True)
        ___qtablewidgetitem9 = self.tb_clientes.item(0, 2)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("MainWindow", u"Mozart Andrade", None));
        ___qtablewidgetitem10 = self.tb_clientes.item(0, 3)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("MainWindow", u"Estrada do Gale\u00e3o", None));
        ___qtablewidgetitem11 = self.tb_clientes.item(0, 4)
        ___qtablewidgetitem11.setText(QCoreApplication.translate("MainWindow", u"2716", None));
        ___qtablewidgetitem12 = self.tb_clientes.item(0, 5)
        ___qtablewidgetitem12.setText(QCoreApplication.translate("MainWindow", u"Bloco 1 casa 103", None));
        ___qtablewidgetitem13 = self.tb_clientes.item(0, 6)
        ___qtablewidgetitem13.setText(QCoreApplication.translate("MainWindow", u"Portuguesa", None));
        ___qtablewidgetitem14 = self.tb_clientes.item(0, 7)
        ___qtablewidgetitem14.setText(QCoreApplication.translate("MainWindow", u"3393-8733", None));
        ___qtablewidgetitem15 = self.tb_clientes.item(0, 8)
        ___qtablewidgetitem15.setText(QCoreApplication.translate("MainWindow", u"mozart@email.com.br", None));
        self.tb_clientes.setSortingEnabled(__sortingEnabled)
        ...
        self.lineEdit_57.setPlaceholderText(QCoreApplication.translate("MainWindow", u"PESQUISAR", None))
        self.comboBox_6.setPlaceholderText(QCoreApplication.translate("MainWindow", u"SELECIONE", None))
        ___qtablewidgetitem16 = self.tb_produtos.horizontalHeaderItem(0)
        ___qtablewidgetitem16.setText(QCoreApplication.translate("MainWindow", u"X", None));
        ___qtablewidgetitem17 = self.tb_produtos.horizontalHeaderItem(1)
        ___qtablewidgetitem17.setText(QCoreApplication.translate("MainWindow", u"ID", None));
        ___qtablewidgetitem18 = self.tb_produtos.horizontalHeaderItem(2)
        ___qtablewidgetitem18.setText(QCoreApplication.translate("MainWindow", u"PRODUTO", None));
        ___qtablewidgetitem19 = self.tb_produtos.horizontalHeaderItem(3)
        ___qtablewidgetitem19.setText(QCoreApplication.translate("MainWindow", u"UNIDADE", None));
        ___qtablewidgetitem20 = self.tb_produtos.horizontalHeaderItem(4)
        ___qtablewidgetitem20.setText(QCoreApplication.translate("MainWindow", u"QUANTIDADE", None));
        ___qtablewidgetitem21 = self.tb_produtos.horizontalHeaderItem(5)
        ___qtablewidgetitem21.setText(QCoreApplication.translate("MainWindow", u"VALOR COMPRA", None));
        ___qtablewidgetitem22 = self.tb_produtos.horizontalHeaderItem(6)
        ___qtablewidgetitem22.setText(QCoreApplication.translate("MainWindow", u"VALOR VENDA", None));
        ___qtablewidgetitem23 = self.tb_produtos.horizontalHeaderItem(7)
        ___qtablewidgetitem23.setText(QCoreApplication.translate("MainWindow", u"DATA DA COMPRA", None));

        __sortingEnabled1 = self.tb_produtos.isSortingEnabled()
        self.tb_produtos.setSortingEnabled(False)
        ___qtablewidgetitem24 = self.tb_produtos.item(0, 2)
        ___qtablewidgetitem24.setText(QCoreApplication.translate("MainWindow", u"Mozart Andrade", None));
        ___qtablewidgetitem25 = self.tb_produtos.item(0, 3)
        ___qtablewidgetitem25.setText(QCoreApplication.translate("MainWindow", u"Estrada do Gale\u00e3o", None));
        ___qtablewidgetitem26 = self.tb_produtos.item(0, 4)
        ___qtablewidgetitem26.setText(QCoreApplication.translate("MainWindow", u"2716", None));
        ___qtablewidgetitem27 = self.tb_produtos.item(0, 5)
        ___qtablewidgetitem27.setText(QCoreApplication.translate("MainWindow", u"Bloco 1 casa 103", None));
        ___qtablewidgetitem28 = self.tb_produtos.item(0, 6)
        ___qtablewidgetitem28.setText(QCoreApplication.translate("MainWindow", u"Portuguesa", None));
        ___qtablewidgetitem29 = self.tb_produtos.item(0, 7)
        ___qtablewidgetitem29.setText(QCoreApplication.translate("MainWindow", u"3393-8733", None));
        self.tb_produtos.setSortingEnabled(__sortingEnabled1)

        self.pushButton_26.setText(QCoreApplication.translate("MainWindow", u"Salvar", None))
        self.pushButton_29.setText(QCoreApplication.translate("MainWindow", u"Excluir", None))
        self.pushButton_30.setText(QCoreApplication.translate("MainWindow", u"Alterar", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"PEDIDOS", None))
        self.lineEdit_10.setPlaceholderText(QCoreApplication.translate("MainWindow", u"PESQUISAR", None))
        self.comboBox_2.setPlaceholderText(QCoreApplication.translate("MainWindow", u"SELECIONE", None))
        ___qtablewidgetitem30 = self.tb_produtos_2.horizontalHeaderItem(0)
        ___qtablewidgetitem30.setText(QCoreApplication.translate("MainWindow", u"X", None));
        ___qtablewidgetitem31 = self.tb_produtos_2.horizontalHeaderItem(1)
        ___qtablewidgetitem31.setText(QCoreApplication.translate("MainWindow", u"PEDIDO", None));
        ___qtablewidgetitem32 = self.tb_produtos_2.horizontalHeaderItem(2)
        ___qtablewidgetitem32.setText(QCoreApplication.translate("MainWindow", u"CLIENTE", None));
        ___qtablewidgetitem33 = self.tb_produtos_2.horizontalHeaderItem(3)
        ___qtablewidgetitem33.setText(QCoreApplication.translate("MainWindow", u"PRODUTO", None));
        ___qtablewidgetitem34 = self.tb_produtos_2.horizontalHeaderItem(4)
        ___qtablewidgetitem34.setText(QCoreApplication.translate("MainWindow", u"QUANTIDADE", None));
        ___qtablewidgetitem35 = self.tb_produtos_2.horizontalHeaderItem(5)
        ___qtablewidgetitem35.setText(QCoreApplication.translate("MainWindow", u"VALOR UNIT\u00c1RIO", None));
        ___qtablewidgetitem36 = self.tb_produtos_2.horizontalHeaderItem(6)
        ___qtablewidgetitem36.setText(QCoreApplication.translate("MainWindow", u"SUBTOTAL", None));
        ___qtablewidgetitem37 = self.tb_produtos_2.horizontalHeaderItem(7)
        ___qtablewidgetitem37.setText(QCoreApplication.translate("MainWindow", u"DATA", None));

        __sortingEnabled2 = self.tb_produtos_2.isSortingEnabled()
        self.tb_produtos_2.setSortingEnabled(False)
        ___qtablewidgetitem38 = self.tb_produtos_2.item(0, 2)
        ___qtablewidgetitem38.setText(QCoreApplication.translate("MainWindow", u"Mozart Andrade", None));
        ___qtablewidgetitem39 = self.tb_produtos_2.item(0, 3)
        ___qtablewidgetitem39.setText(QCoreApplication.translate("MainWindow", u"Estrada do Gale\u00e3o", None));
        ___qtablewidgetitem40 = self.tb_produtos_2.item(0, 4)
        ___qtablewidgetitem40.setText(QCoreApplication.translate("MainWindow", u"2716", None));
        ___qtablewidgetitem41 = self.tb_produtos_2.item(0, 5)
        ___qtablewidgetitem41.setText(QCoreApplication.translate("MainWindow", u"Bloco 1 casa 103", None));
        ___qtablewidgetitem42 = self.tb_produtos_2.item(0, 6)
        ___qtablewidgetitem42.setText(QCoreApplication.translate("MainWindow", u"Portuguesa", None));
        self.tb_produtos_2.setSortingEnabled(__sortingEnabled2)

        self.pushButton_14.setText(QCoreApplication.translate("MainWindow", u"Salvar", None))
        self.pushButton_27.setText(QCoreApplication.translate("MainWindow", u"Excluir", None))
        self.pushButton_28.setText(QCoreApplication.translate("MainWindow", u"Alterar", None))
        self.label_32.setText(QCoreApplication.translate("MainWindow", u"FORNECEDORES", None))
        self.lineEdit_115.setPlaceholderText(QCoreApplication.translate("MainWindow", u"PESQUISAR", None))
        self.comboBox_13.setPlaceholderText(QCoreApplication.translate("MainWindow", u"SELECIONE", None))
        ___qtablewidgetitem43 = self.tb_fornecedores.horizontalHeaderItem(0)
        ___qtablewidgetitem43.setText(QCoreApplication.translate("MainWindow", u"CNPJ/CPF", None));
        ___qtablewidgetitem44 = self.tb_fornecedores.horizontalHeaderItem(1)
        ___qtablewidgetitem44.setText(QCoreApplication.translate("MainWindow", u"NOME DO FORNECEDOR", None));
        ___qtablewidgetitem45 = self.tb_fornecedores.horizontalHeaderItem(2)
        ___qtablewidgetitem45.setText(QCoreApplication.translate("MainWindow", u"TELEFONE", None));
        ___qtablewidgetitem46 = self.tb_fornecedores.horizontalHeaderItem(3)
        ___qtablewidgetitem46.setText(QCoreApplication.translate("MainWindow", u"EMAIL", None));

        __sortingEnabled3 = self.tb_fornecedores.isSortingEnabled()
        self.tb_fornecedores.setSortingEnabled(False)
        ___qtablewidgetitem47 = self.tb_fornecedores.item(0, 2)
        ___qtablewidgetitem47.setText(QCoreApplication.translate("MainWindow", u"Mozart Andrade", None));
        ___qtablewidgetitem48 = self.tb_fornecedores.item(0, 3)
        ___qtablewidgetitem48.setText(QCoreApplication.translate("MainWindow", u"Estrada do Gale\u00e3o", None));
        self.tb_fornecedores.setSortingEnabled(__sortingEnabled3)

        self.pushButton_50.setText(QCoreApplication.translate("MainWindow", u"Salvar", None))
        self.pushButton_51.setText(QCoreApplication.translate("MainWindow", u"Excluir", None))
        self.pushButton_52.setText(QCoreApplication.translate("MainWindow", u"Alterar", None))
    # retranslateUi
